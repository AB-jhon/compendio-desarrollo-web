            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-4">
                    ...
                    <div className="p-5 bg-white dark:bg-slate-800 rounded-2xl border-l-4 border-l-purple-500 shadow-sm">
                        <p className="text-sm">Identificación de requisitos mínimos viables (MVP). Por ejemplo, en un E-commerce: Carrito, Catálogo y Pasarela de Pagos.</p>
                    </div>
                </div>

                <div className="space-y-4">
                    <h3 className="flex items-center gap-2 text-xl font-bold text-slate-800 dark:text-white">
                        <TrendingUp className="text-orange-500" /> Monitoreo (KPIs)
                    </h3>
